...
import (
	...
	"github.com/tnyidea/httpserver/go/sample/userservice/data/types"
	"log"
	"testing"
)
...
func TestUpdateUser(t *testing.T) {
	...
	modifyUser, err := db.FindUserByUUID("8e78fa20-6050-4236-9f14-04e232fd04ed")
	if err != nil {
		log.Println(err)
		t.FailNow()
	}
...
func TestDeleteUser(t *testing.T) {
	...
	deletedUser, err := db.DeleteUserByUUID("8e78fa20-6050-4236-9f14-04e232fd04ed")
	if err != nil {
		log.Println(err)
		t.FailNow()
	}
